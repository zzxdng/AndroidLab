...
public class GIFAndSVGAPlayDemoActivity extends AppCompatActivity {
    ...
    private String mGifUrl = "http://img.soogif.com/4UC0PsP0g8buEDpWB4ikm1bQu0yFI7iK.gif";
...
//        Glide.with(this).asGif().load(mGifUrl).listener(new RequestListener<GifDrawable>() {
//            @Override
...
//                try {
//                    mGifDrawablerawable = new pl.droidsonroids.gif.GifDrawable(resource.getBuffer());
//                } catch (IOException e) {
//                    e.printStackTrace();
//                }
...
//        //Glide
//        try {
//            Glide.with(this).asGif().load(getAssets().open("draw_s_start.gif")).listener(new RequestListener<GifDrawable>() {
//                @Override
//                public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<GifDrawable> target, boolean isFirstResource) {
//                    return false;
//                }
